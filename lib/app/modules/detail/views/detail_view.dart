    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: typeColors[detailController.dataDetailProgram.value.types?.first.type.name.toLowerCase()] ?? Colors.grey,
        ),
        body: Obx(() {
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(detailController.dataDetailProgram.value.name ?? "",
                    style: const TextStyle(
                      fontSize: 20,
